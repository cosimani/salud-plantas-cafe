...
# Ejecutar con:
# python demo.py ^
  # --data_selection 4 ^                 # CoffeeLeaves (lo agregaste en Demo_Parameters)
  # --pooling_layer 6 ^                  # 6 = MS_Lacunarity (mejor que 5=Base en el paper)
  # --agg_func 1 ^                       # 1 = global
  # --model resnet18 ^                   # también podés probar convnext_tiny.fb_in22k
  # --use_pretrained ^                   # usa pesos ImageNet
  # --feature_extraction False ^         # 🔥 fine-tuning completo (descongela el backbone)
  # --num_epochs 20 ^                    # con early stopping 10 ya configurado
  # --lr 0.001 ^                         # LR más bajo para FT completo
  # --train_batch_size 64 ^              # RTX 4060 (8GB) suele bancar 64 en ResNet18
  # --val_batch_size 64 ^
  # --test_batch_size 64
